...
version "6.7" "6.8.3" "7.0" "7.1" "7.2" "7.3.2" "7.4.2" "7.5" "7.6" "7.6.1" "7.6.2"
        ...
        "9.4.1" "9.5.0" "9.5.1" "9.6.0" "9.6.1" "9.7.0" "9.7.1" "9.8.0" {
  auto-version {
    html {
      url = "https://gradle.org/releases/"
      css = "body > div.site-layout__body > div > main > div > h3 > span:nth-child(2) > a"
    }
  }
}
...
sha256sums = {
  ...
  "https://services.gradle.org/distributions/gradle-9.8.0-bin.zip": "bafd5ce9cfaea0fbccfdc8439a1ac42fbd4cd9c89dc9a988228d8a2639a58e6c",
}
