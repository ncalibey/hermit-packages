...
version "2.17.0" "2.20.0" "2.21.0" "3.0.0" "3.0.2" "3.0.4" "3.1.0" "3.1.1" "3.2.0"
        ...
        "3.7.1" "3.8.0" "4.0.0" "4.0.1" "4.1.0" "4.2.0" "4.3.0" "4.5.0" "4.5.1" "4.6.0" "4.6.1"
        "4.6.2" {
  auto-version {
...
sha256sums = {
  ...
  "https://github.com/pre-commit/pre-commit/releases/download/v4.6.1/pre-commit-4.6.1.pyz": "6768cc8f4f810509b9272211c70ef7bb405c52da2ba81b673b2c361a72f1815d",
  "https://github.com/pre-commit/pre-commit/releases/download/v4.6.2/pre-commit-4.6.2.pyz": "43c09a73d82af8efff09900e60d76d67a2c3d990613c3c770b2b5c4418a16c4b",
}
