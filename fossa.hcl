...
version "3.0.12" "3.0.14" "3.0.15" "3.0.16" "3.0.17" "3.0.18" "3.1.0" "3.1.2" "3.1.3"
        ...
        "3.6.10" "3.6.13" "3.6.14" "3.6.15" "3.6.17" "3.6.18" "3.7.0" "3.7.1" "3.7.2" "3.7.3"
        "3.7.4" "3.7.5" "3.7.6" "3.7.7" "3.7.9" {
  auto-version {
...
sha256sums = {
  ...
  "https://github.com/fossas/fossa-cli/releases/download/v3.6.13/fossa_3.6.13_darwin_amd64.zip": "890eaec1a51d82415488acdd81cd25ca2ed210063b7d7e9ef0c0fa3d2bb0b193",
  "https://github.com/fossas/fossa-cli/releases/download/v3.6.13/fossa_3.6.13_linux_amd64.zip": "7d06b2abf0c61bf90154021cf51543d30bb2b24909d024254e82b269e8396b3f",
